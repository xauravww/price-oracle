...
const mockEntries: PriceEntry[] = [
  { id: '1', item: 'Auto', location: '110001', price: 100, timestamp: new Date(), upvotes: 0, isTrusted: false },
  { id: '2', item: 'Auto', location: '110001', price: 110, timestamp: new Date(), upvotes: 0, isTrusted: false },
  { id: '3', item: 'Auto', location: '110001', price: 90, timestamp: new Date(), upvotes: 0, isTrusted: false },
];
